  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-br from-[#0f0f23] via-[#1a1a2e] to-[#16213e] relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <button
          onClick={closeModal}
          className="absolute -top-4 -right-4 z-10 w-10 h-10 bg-red-500/80 hover:bg-red-500 text-white rounded-full flex items-center justify-center transition-colors"
        >
