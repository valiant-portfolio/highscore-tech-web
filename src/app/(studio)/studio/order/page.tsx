    ...
    <section className="px-4 md:px-8 py-10 md:py-14">
      <div className="mx-auto max-w-[1140px]">
        <header className="mb-8 max-w-2xl">
          <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-brand">Your order</p>
          <h1 className="mt-3 font-display text-3xl md:text-5xl font-extrabold tracking-[-0.03em] text-fg">
            Let’s make something.
          </h1>
          <p className="mt-4 text-fg-muted leading-relaxed">
            A few quick steps. The more you tell us in the brief, the better the work comes
